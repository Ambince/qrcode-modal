...
var copy_ = require('copy-to-clipboard');
...
var windowGetters$1 = require('window-getters');
...
function setLocal(key, data) {
  ...
  var local = windowGetters$1.getLocalStorage();
...
function MobileLinkDisplay(props) {
  ...
  }, props.text.choose_preferred_wallet), React.createElement("div", {
    className: ("walletconnect-connect__buttons__wrapper" + (grid ? "__wrap" : ""))
...
function Modal(props) {
  ...
  return React.createElement("div", {
    ...
    onClick: function () { return setDisplayQRCode(false); }
  }, props.text.desktop)) : React.createElement("div", {
    className: ("walletconnect-modal__mobile__toggle" + (!displayQRCode ? " right__selected" : ""))
  }, React.createElement("div", {
    className: "walletconnect-modal__mobile__toggle_selector"
  }), React.createElement("a", {
    ...
    onClick: function () { return setDisplayQRCode(false); }
  }, props.text.desktop)), React.createElement("div", null, displayQRCode ? React.createElement(QRCodeDisplay, Object.assign({}, displayProps)) : React.createElement(MobileLinkDisplay, Object.assign({}, displayProps)))));
}
